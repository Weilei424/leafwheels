      ...
      {result?.status === "APPROVED" ? (
          <div className="space-y-6">
            ...
            <div>
              ...
              {/* ✅ ENHANCED: Show payment and order details */}
            ...
            <div className="space-y-3">
              ...
              <motion.button
                  ...
                  className="w-full bg-gray-100 text-gray-700 py-3 px-6 rounded-lg hover:bg-gray-200 font-medium transition-colors"
              >
                View Order Details
              </motion.button>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-600">
                {result?.failureReason || "Please try again with a different payment method."}
              </p>

              {/* ✅ ENHANCED: Show more failure details if available */}
              {result?.errorCode && (
