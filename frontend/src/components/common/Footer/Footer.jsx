                    ...
                    <div className="md:col-span-1">
                        <div className="flex items-center gap-2 mb-3">
                            <div className="w-6 h-6 rounded-lg flex items-center justify-center">
                                <img src="/logo.png" alt="LeafWheels Logo" className="w-6 h-6" />
                            </div>
                            <h2 className="text-lg font-medium text-gray-900">LeafWheels</h2>
                        </div>
                        ...
                        <div className="flex space-x-2">
                            {[
                                ...
                                <a
                                    key={index}
                                    href="#"
                                    className="w-7 h-7 bg-gray-100 rounded-md flex items-center justify-center text-gray-500 hover:bg-green-600 hover:text-white transition-colors duration-200"
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {[
                                ...
                                { name: "Electric Cars", href: "/store?category=Vehicles" },
