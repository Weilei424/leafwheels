            ...
            <div className="footer-container">
                <div className="footer-grid">
                    ...
                    <div className="footer-box">
                        ...
                        <ul className="footer-list">
                            <li className="footer-list-item"> get Rekt. No customer service. </li>
                            {/*<li className="footer-list-item">Help Center</li>*/}
                            {/*<li className="footer-list-item">How to Buy</li>*/}
                            {/*<li className="footer-list-item">Track Your Order</li>*/}
                            {/*<li className="footer-list-item">Corporate & Bulk Purchasing</li>*/}
                            {/*<li className="footer-list-item">Returns & Refunds</li>*/}
                        </ul>
                    </div>
